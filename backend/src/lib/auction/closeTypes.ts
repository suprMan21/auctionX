 ...
 * Zod schemas and types for close-auction and offer-cascade outcomes.
 * Ported from functions/src/v1/services/orchestration/auction.close.types.ts
 */
...
/** Discriminated union of all possible close outcomes. */
...
/** Full result returned by the closeAuction orchestrator on success. */
